...
class PositionalEncoding(nn.Module):
    def __init__(self, hidden, dropout = 0.1, max_len = 32):
        super().__init__()
    ...
    def forward(self, x):
        ...
        """
        #print('x_shape10',x.shape)
        #print('pe_shape10',self.pe.shape)
        x = x + self.pe[:x.size(0)]
        return self.dropout(x)

class AttnModule(nn.Module):
    def __init__(self, hidden = 10, layers = 12, record_attn = False, inpu_dim = 10):
